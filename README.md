...
| <a href="docs/examples/gallery/plain.html"><img src="docs/examples/gallery/plain.png" alt="Prose rendered in the plain template" width="400"></a><br>**`--style plain`** · no template CSS at all<br>[source](docs/examples/gallery/plain.md) · [rendered](docs/examples/gallery/plain.html) | <a href="docs/examples/gallery/minutes.html"><img src="docs/examples/gallery/minutes.png" alt="Meeting minutes rendered in the minutes template" width="400"></a><br>**`--type minutes`** · what a meeting agreed and decided<br>[source](docs/examples/gallery/minutes.md) · [rendered](docs/examples/gallery/minutes.html) |
...
- Serves a page resolved by convention together with **the images that page references**, by
  ...
  repository is a 404 under that hostname. The tree and the page are cached per commit, so a
  reload costs one GitHub call and a push is still visible on the next request. Until this was
  fixed, a convention page declared `/index.html` alone and every image on it was a 404.
