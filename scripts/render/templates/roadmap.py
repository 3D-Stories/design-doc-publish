...
.tpl-roadmap .blk-ph-head{display:flex;align-items:baseline;gap:12px;flex-wrap:wrap}
...
.tpl-roadmap .blk-ph-title{flex:1 1 auto;min-width:18ch;font-size:15.5px;font-weight:700}
.tpl-roadmap .blk-ph-badge{flex:0 1 auto;min-width:0;max-width:100%;white-space:normal;
overflow-wrap:anywhere;font:700 10px/1.6 ui-monospace,Menlo,Consolas,monospace;
